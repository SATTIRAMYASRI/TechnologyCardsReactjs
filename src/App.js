...
const App = () => (
  <div className="bg-container">
    <div className="contianer-alignment">
      ...
      <div className="FlexContainerAlignment-1">
        <ul className="FlexContainerAlignment-2">
          {cardsList.map(eachItem => (
            <Technology cardDetails={eachItem} key={eachItem.id} />
          ))}
        </ul>
      </div>
    </div>
